...
export default function ProspectusPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadAsPdf('prospectus-doc', 'elyon-schools-prospectus.pdf')
    } finally {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-8 py-12">
        <div id="prospectus-doc">
          <div className="text-center mb-10 border-b-2 border-primary pb-8">
            <img src="/logo.png" alt="Elyon Schools" className="h-20 w-20 object-contain mx-auto mb-3" />
