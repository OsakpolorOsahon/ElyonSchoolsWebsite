      ...
      {mobileMenuOpen && (
        <div role="dialog" aria-modal="true">
          <div
            ...
            aria-hidden="true"
          />
          <div className="animate-slide-from-right fixed inset-y-0 right-0 z-[210] w-full overflow-y-auto bg-background px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-border shadow-xl">
